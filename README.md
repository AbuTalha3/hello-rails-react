...
In this web application, I have implemented a connection between a Ruby on `Rails back-end` and a `React front-end` in one app as per the given instructions.
...
```sh
  cd my-folder
  gh repo clone https:git@github.com:AbuTalha3/hello-rails-react.git
...
I would like to thank **MicroverseInc** for including this in their curriculum and providing the opportunity to work on it and learn more and more.
